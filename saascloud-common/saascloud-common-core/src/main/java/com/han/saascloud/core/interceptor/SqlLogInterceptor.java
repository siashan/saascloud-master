...
import com.han.saascloud.base.constant.NumberConstant;
import com.han.saascloud.core.aspect.NotDisplaySqlAspect;
...
public class SqlLogInterceptor implements Interceptor {
	@Value("${saascloud.enableSqlLogInterceptor}")
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (enableSqlLogInterceptor) {
			...
			if (time >= noticeTime * NumberConstant.THOUSAND_INT) {
